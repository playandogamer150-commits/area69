            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  disabled
                  className="flex cursor-not-allowed items-center justify-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.03] py-3 opacity-50"
                >
                  ...
                  <span className="rounded bg-white/[0.08] px-1.5 py-0.5 text-[9px] font-semibold tracking-wider text-gray-400">EM BREVE</span>
                </button>
                <button
                  type="button"
                  disabled
